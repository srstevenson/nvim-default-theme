...
vim.api.nvim_set_hl(0, "StatusLine", { fg = DarkGrey2, bg = LightGrey4 })
vim.api.nvim_set_hl(0, "StatusLineNC", { fg = DarkGrey3, bg = LightGrey3 })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineError", { underline = true, sp = DarkRed })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineHint", { underline = true, sp = DarkBlue })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo", { underline = true, sp = DarkCyan })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineOk", { underline = true, sp = DarkGreen })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", { underline = true, sp = DarkYellow })
